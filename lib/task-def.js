...
TaskDef.prototype.mochaTest = function () {
    var mochaTestConfig = {};
    var verificationTests = this.spec.scenario.type.map(function (type) {
        return 'test/verification/' + type + '_output_test.js';
    });
    mochaTestConfig[this.spec.scenarioName] = {
        src: verificationTests
    };
    extend(this.config.mochaTest, mochaTestConfig);
};
